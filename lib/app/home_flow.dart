    ...
    await _apiService.patchJson(
      ...
      body: <String, dynamic>{
        ...
        'bodyMetrics': <String, dynamic>{
          ...
          if (payload.subcutaneousFat != null) 'subcutaneousFat': payload.subcutaneousFat,
          if (payload.visceralFat != null) 'visceralFat': payload.visceralFat,
          if (payload.muscleMass != null) 'muscleMass': payload.muscleMass,
          if (payload.skeletalMuscle != null) 'skeletalMuscle': payload.skeletalMuscle,
          if (payload.muscleRate != null) 'muscleRate': payload.muscleRate,
          if (payload.waterContent != null) 'waterContent': payload.waterContent,
          if (payload.protein != null) 'protein': payload.protein,
          if (payload.bmr != null) 'bmr': payload.bmr,
          if (payload.boneMass != null) 'boneMass': payload.boneMass,
          if (payload.physicalAge != null) 'physicalAge': payload.physicalAge,
          if (payload.bodyScore != null) 'bodyScore': payload.bodyScore,
        },
